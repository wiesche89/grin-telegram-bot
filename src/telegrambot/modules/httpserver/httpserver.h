...
struct HttpServerResponsePrivate
{
    ...
    const QMap<qint32, QString> StatusNames{
        ...
        {302, "Found"}, {303, "See Other"}, {304, "Not Modified"}, {305, "Use Proxy"}, {306, "Switch Proxy"}, {307, "Temporary Redirect"},
        ...
        {424, "Failed Dependency"}, {426, "Upgrade Required"}, {428, "Precondition Required"}, {429, "Too Many Requests"},
        ...
        {510, "Not Extended"}, {511, "Network Authentication Required"}, {103, "Checkpoint"}, {103, "Early Hints"}, {420, "Method Failure"},
        {420, "Enhance Your Calm"}, {450, "Blocked by Windows Parental Controls"}, {498, "Invalid Token"}, {499, "Token Required"},
        {509, "Bandwidth Limit Exceeded"}, {530, "Site is frozen"}, {598, "Network read timeout error"},
        {599, "Network connect timeout error"}, {440, "Login Time-out"}, {449, "Retry With"}, {451, "Redirect"}, {444, "No Response"},
        {495, "SSL Certificate Error"}, {496, "SSL Certificate Required"}, {497, "HTTP Request Sent to HTTPS Port"},
        {499, "Client Closed Request"}, {520, "Unknown Error"}, {521, "Web Server Is Down"}, {522, "Connection Timed Out"},
