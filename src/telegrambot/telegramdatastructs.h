...
struct TelegramBotOperationResult : public TelegramBotObject {
    ...
    TelegramBotOperationResult(QJsonObject object)
    {
...
struct TelegramBotUser : public TelegramBotObject {
    ...
    TelegramBotUser(QJsonObject object)
    {
        this->fromJson(object);
    }
...
struct TelegramBotChat : public TelegramBotObject {
    qlonglong id; // Unique identifier for this chat. This number may be greater than 32 bits and some programming languages may have difficulty/silent defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit integer or double-precision float type are safe for storing this identifier.
    ...
    TelegramBotChat(QJsonObject object)
    {
        this->fromJson(object);
    }
...
struct TelegramBotUserProfilePhotos : public TelegramBotObject {
    ...
    TelegramBotUserProfilePhotos(QJsonObject object)
    {
        this->fromJson(object);
    }
...
struct TelegramBotFile : public TelegramBotObject {
    ...
    TelegramBotFile(QJsonObject object)
    {
        this->fromJson(object);
    }
...
struct TelegramBotChatMember : public TelegramBotObject {
    ...
    TelegramBotChatMember(QJsonObject object)
    {
        this->fromJson(object);
    }
...
struct TelegramBotUpdatePrivate : public TelegramBotObject {
    ...
    virtual void fromJson(QJsonObject &object)
    {
        for (auto itr = object.begin(); itr != object.end(); itr++) {
            ...
            // parse InlineQuery
            else if (this->type == InlineQuery) {
                (this->inlineQuery = new TelegramBotInlineQuery)->fromJson(oMessage);
            }
            // parse ChosenInlineResult
            else if (this->type == ChosenInlineResult) {
                (this->chosenInlineResult = new TelegramBotChosenInlineResult)->fromJson(oMessage);
            }
            // parse TelegramBotCallbackQuery
            else if (this->type == CallbackQuery) {
                (this->callbackQuery = new TelegramBotCallbackQuery)->fromJson(oMessage);
            }
